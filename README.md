...
- `ocp-dog-deployer-full`: permisos de creación, actualización, lectura y borrado sobre los recursos necesarios para desplegar (ConfigMaps, Secrets, Services, Pods, PVCs, Deployments, ReplicaSets, StatefulSets, DaemonSets, HPAs y Routes) dentro del namespace.
